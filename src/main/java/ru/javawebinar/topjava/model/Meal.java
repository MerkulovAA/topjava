...
public class Meal extends AbstractBaseEntity {
    ...
    @NotNull(groups = {ValidationWithoutUser.class, Default.class})
    @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm")
    private LocalDateTime dateTime;

    @Column(name = "description", nullable = false)
    @NotBlank(groups = {ValidationWithoutUser.class, Default.class})
    @Size(min = 2, max = 120, groups = {ValidationWithoutUser.class, Default.class})
    private String description;

    @Column(name = "calories", nullable = false)
    @Range(min = 10, max = 5000, groups = {ValidationWithoutUser.class, Default.class})
    @NotNull(groups = {ValidationWithoutUser.class, Default.class})
